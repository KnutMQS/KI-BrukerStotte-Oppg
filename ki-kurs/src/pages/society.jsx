function Society() {
  return (
    <>
      ...
      <div className="flex justify-center mx-auto h-135 rounded-4xl border-2 border-solid border-indigo-600 w-250 bg-[url(./assets/AISociety.png)] bg-center bg-cover bg-no-repeat">
        <p className="p-7 bg-indigo-950 h-fit w-fit rounded-t-4xl border-b-2 border-solid border-indigo-600 text-2xl">
